...
class Target(Sprite):
    ...
    def update(self):
        self.x += self.settings.target_speed * self.direction
        self.rect.x = self.x
...
def run_game():
    ...
    pygame.display.set_caption("Trying It Yourself")
    ...
    while True:
        ...
        for bullet in bullets.sprites():
            bullet.draw()
        info = font.render(f"Hits: {hits}", True, (230, 230, 230))
